...
<body>
                        ...
                        <section class="widget full-width">
                            ...
                            <div class="widget-content">
                                <div class="analysis-second-placeholder">
                                    ...
                                    <div class="analysis-item">
                                        <h3>Summary</h3>
                                        <!-- Update the gauge section in your HTML -->
                                        <div class="gauge-container">
                                            <div class="analyst-price-target_gaugeContainer__F_79r" id="gaugeContainer" style="width: 300px; height: 135px;" data-c="2">
                                                <div class="analyst-price-target_gauge__mc_8B" style="width: 204px; height: 102px;">
                                                    ...
                                                    <div class="analyst-price-target_bar__nhotN" data-i="2" style="left: 80px; width: 40px; background: #f59e0b;"></div>
                                                    ...
                                                    <div class="analyst-price-target_indicator__dhPLO" style="width: 198px; height: 198px; top: 3px; left: 3px;">
                                                        <div class="analyst-price-target_arrow__ZRmAZ" id="gaugeArrow" style="bottom: 101px; left: 98px; height: 60px; transform: rotate(90deg);">
                                            ...
                                            <div class="gauge-rating neutral" id="gaugeRating">Neutral</div>
                                        </div>
                                        <div class="summary-details">
                                            <div class="indicator-row">
                                                <span>Moving Averages:</span>
                                                <span class="rating-text neutral" id="maRating">Loading...</span>
                                                <span id="maCounts">-</span>
                                            </div>
                                            <div class="indicator-row">
                                                <span>Technical Indicators:</span>
                                                <span class="rating-text neutral" id="tiRating">Loading...</span>
                                    ...
                                    <div class="analysis-item">
                                        ...
                                        <div class="table-header">
                                            <span>Summary: <strong class="rating-text neutral" id="tiSummary">Loading...</strong></span>
                                        ...
                                        <div class="table-container">
                                            <table class="rates-table" id="tiTable">
                                                ...
                                                <tbody id="tiTableBody">
                                                    <tr><td colspan="3" class="loading-cell">Loading technical indicators...</td></tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
                                    ...
                                    <div class="analysis-item">
                                        ...
                                        <div class="table-header">
                                            <span>Summary: <strong class="rating-text neutral" id="maSummary">Loading...</strong></span>
                                        ...
                                        <div class="table-container">
                                            <table class="rates-table" id="maTable">
                                                ...
                                                <tbody id="maTableBody">
                                                    <tr><td colspan="3" class="loading-cell">Loading moving averages...</td></tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-container">
                                            <table class="rates-table" id="pivotTable">
                                                ...
                                                <tbody id="pivotTableBody">
                                                    <tr><td colspan="8" class="loading-cell">Loading pivot points...</td></tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
                                ...
                                <div class="table-container">
                                    <table class="rates-table" id="ratesTable">
                                        ...
                                        <tbody id="ratesTableBody">
                                            <tr><td colspan="7" class="loading-cell">Loading interest rates data...</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="widget-footer">
                                    ...
                                    <div class="footer-right">
                                        <div class="data-info">
                                            ...
                                            <span>Last scraped: <span id="scrapeTime">Loading...</span></span>
                                        </div>
                            ...
                            <div class="widget-content">
                                <div class="detailed-analysis">
                                    <div class="analysis-card">
                                        <h4>Price Action</h4>
                                        <p id="priceActionText">Loading price action analysis...</p>
                                        <div class="analysis-tags" id="priceActionTags">
                                            <span class="tag neutral">Loading</span>
                                        </div>
                                    </div>
                                    <div class="analysis-card">
                                        <h4>Volume Analysis</h4>
                                        <p id="volumeAnalysisText">Loading volume analysis...</p>
                                        <div class="analysis-tags" id="volumeAnalysisTags">
                                            <span class="tag neutral">Loading</span>
                                        </div>
                                    </div>
                                    <div class="analysis-card">
                                        <h4>Risk Levels</h4>
                                        <p id="riskLevelsText">Loading risk levels...</p>
                                        <div class="analysis-tags" id="riskLevelsTags">
                                            <span class="tag neutral">Loading</span>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        function initializeGaugeAsNeutral() {
            console.log('Initializing gauge as neutral...');
            ...
            if (gaugeContainer) {
                gaugeContainer.setAttribute('data-c', '2');
                console.log('Gauge container set to index 2');
            }
            
            if (gaugeArrow) {
                gaugeArrow.style.transform = 'rotate(90deg)'; // 90° = neutral (straight up)
                console.log('Gauge arrow set to 90° (neutral)');
            }
            
            if (gaugeRating) {
                gaugeRating.textContent = 'Neutral';
                gaugeRating.className = 'gauge-rating neutral';
                console.log('Gauge rating set to Neutral');
            }
            ...
            console.log('Gauge initialization complete');
        }

        // Update gauge based on rating - FIXED NEEDLE POSITIONS
        function updateGauge(rating) {
            console.log('Updating gauge with rating:', rating);
            
            const ratingMap = {
                'strong sell': { index: 0, angle: 50, className: 'strong-sell' },
                'sell': { index: 1, angle: 70, className: 'sell' },
                'neutral': { index: 2, angle: 90, className: 'neutral' },
                'buy': { index: 3, angle: 110, className: 'buy' },
                'strong buy': { index: 4, angle: 130, className: 'strong-buy' },
                'Strong Sell': { index: 0, angle: 50, className: 'strong-sell' },
                'Sell': { index: 1, angle: 70, className: 'sell' },
                'Neutral': { index: 2, angle: 90, className: 'neutral' },
                'Buy': { index: 3, angle: 110, className: 'buy' },
            ...
            if (gaugeContainer) {
                gaugeContainer.setAttribute('data-c', gaugeData.index);
                console.log('Gauge container index set to:', gaugeData.index);
            }
            ...
            if (gaugeRating) {
                ...
                console.log('Gauge rating updated to:', rating);
            }
        }

        // Parse API response data and adapt it to our UI structure
        function parseApiDataForUI(apiData) {
            console.log('Parsing API data for UI:', apiData);
            
            try {
                const myfxbookData = apiData.myfxbook || {};
                const investingData = apiData.investing || {};
                
                // Parse Myfxbook data
                const parsedMyfxbook = {
                    overallSignal: myfxbookData.overall_signal || 'Neutral',
                    indicators: myfxbookData.indicators || [],
                    support: myfxbookData.support || null,
                    resistance: myfxbookData.resistance || null,
                    pivot: myfxbookData.pivot || null
                };
                
                // Parse Investing.com data
                const parsedInvesting = {
                    overallRating: investingData.overall_rating || 'Neutral',
                    movingAverages: {
                        summary: investingData.moving_averages?.summary || 'Neutral',
                        counts: investingData.moving_averages?.counts || '-',
                        table: investingData.moving_averages?.table || []
                    },
                    technicalIndicators: {
                        summary: investingData.technical_indicators?.summary || 'Neutral',
                        counts: investingData.technical_indicators?.counts || '-',
                        table: investingData.technical_indicators?.table || []
                    },
                    pivotPoints: {
                        table: investingData.pivot_points?.table || []
                    },
                    timestamp: apiData.timestamp || new Date().toLocaleString()
                };
                
                console.log('Parsed data:', { parsedMyfxbook, parsedInvesting });
                return {
                    myfxbook: parsedMyfxbook,
                    investing: parsedInvesting
                };
                
            } catch (error) {
                console.error('Error parsing API data:', error);
                return getFallbackData('EURJPY', 'H4').data;
            }
        }

        // Update table data with proper handling
        function updateTableData(tableId, data, isArray = true) {
            ...
            if (data && (isArray ? data.length > 0 : Object.keys(data).length > 0)) {
                tableBody.innerHTML = '';
                ...
                if (isArray) {
                    data.forEach(row => {
                        if (typeof row === 'string') {
                            ...
                            // Handle object rows
                            const rowHtml = Object.values(row).map(cell => 
                                `<td>${cell || '-'}</td>`
                            ).join('');
        ...
        function updateFirstSourceAnalysis(data, symbol, timeframe) {
            console.log('Updating first source analysis:', data);
            
            if (!data) {
                console.warn('No data for first source analysis');
                return;
            }
            
            const overallSignal = document.getElementById('overallSignal');
            if (overallSignal) {
                overallSignal.textContent = data.overallSignal || 'Neutral';
                overallSignal.className = (data.overallSignal || 'neutral').toLowerCase().replace(' ', '-');
            }
            ...
            if (data.indicators && data.indicators.length > 0) {
                ...
                if (indicatorsList) {
                    ...
                    data.indicators.forEach(indicator => {
                        ...
                        div.innerHTML = `
                            <span class="indicator-name">${indicator.name || 'Unknown'}</span>
                            <span class="indicator-value">${indicator.value || '-'}</span>
                            <span class="indicator-action ${(indicator.action || 'neutral').toLowerCase()}">${indicator.action || 'Neutral'}</span>
                        `;
        ...
        function updateSecondSourceAnalysis(data, symbol, timeframe) {
            console.log('Updating second source analysis:', data);
            
            if (!data) {
                console.warn('No data for second source analysis');
                return;
            }
            ...
            const maRating = document.getElementById('maRating');
            const tiRating = document.getElementById('tiRating');
            
            if (maRating && data.movingAverages) {
                maRating.textContent = data.movingAverages.summary || 'Neutral';
                maRating.className = `rating-text ${(data.movingAverages.summary || 'neutral').toLowerCase().replace(' ', '-')}`;
            }
            
            if (document.getElementById('maCounts') && data.movingAverages) {
                document.getElementById('maCounts').textContent = data.movingAverages.counts || '-';
            }
            
            if (tiRating && data.technicalIndicators) {
                tiRating.textContent = data.technicalIndicators.summary || 'Neutral';
                tiRating.className = `rating-text ${(data.technicalIndicators.summary || 'neutral').toLowerCase().replace(' ', '-')}`;
            }
            
            if (document.getElementById('tiCounts') && data.technicalIndicators) {
                document.getElementById('tiCounts').textContent = data.technicalIndicators.counts || '-';
            }
            
            // Update table headers
            const tiSummary = document.getElementById('tiSummary');
            const maSummary = document.getElementById('maSummary');
            
            if (tiSummary && data.technicalIndicators) {
                tiSummary.textContent = data.technicalIndicators.summary || 'Neutral';
                tiSummary.className = (data.technicalIndicators.summary || 'neutral').toLowerCase().replace(' ', '-');
            }
            
            if (document.getElementById('tiSummaryCounts') && data.technicalIndicators) {
                document.getElementById('tiSummaryCounts').textContent = data.technicalIndicators.counts || '-';
            }
            
            if (document.getElementById('tiTimestamp')) {
                document.getElementById('tiTimestamp').textContent = data.timestamp || new Date().toLocaleString();
            }
            
            if (maSummary && data.movingAverages) {
                maSummary.textContent = data.movingAverages.summary || 'Neutral';
                maSummary.className = (data.movingAverages.summary || 'neutral').toLowerCase().replace(' ', '-');
            }
            
            if (document.getElementById('maSummaryCounts') && data.movingAverages) {
                document.getElementById('maSummaryCounts').textContent = data.movingAverages.counts || '-';
            }
            
            if (document.getElementById('maTimestamp')) {
                document.getElementById('maTimestamp').textContent = data.timestamp || new Date().toLocaleString();
            }
            
            // Update tables with data (if provided)
            // These will be populated when we get real data from API
            // For now, show loading or no data messages
        }
        ...
        function updateInterestRatesDashboard(ratesData, symbol) {
            ...
            // Show loading message until we have real data
            const tableBody = document.getElementById('ratesTableBody');
            if (tableBody) {
                tableBody.innerHTML = '<tr><td colspan="7" class="loading-cell">Loading interest rates data...</td></tr>';
            }
        }
        ...
        function updateSupportResistance(symbol, timeframe) {
            ...
            console.log('Updating support/resistance for:', symbol, timeframe);
        }
        ...
        async function fetchTechnicalAnalysis(pair, timeframe) {
            try {
                ...
                if (now - lastApiRequestTime < API_REQUEST_COOLDOWN) {
                    ...
                    console.log(`Rate limited: Please wait ${remainingTime} seconds`);
        ...
        async function updateAnalysis(symbol, timeframe) {
            console.log('Starting analysis update for:', symbol, timeframe);
            ...
            try {
                ...
                // Parse and adapt the API data for our UI
                const parsedData = parseApiDataForUI(apiResponse.data);
                
                // Update Market Analysis First Source (Myfxbook)
                updateFirstSourceAnalysis(parsedData.myfxbook, symbol, timeframe);
                
                // Update Market Analysis Second Source (Investing.com)
                updateSecondSourceAnalysis(parsedData.investing, symbol, timeframe);
                
                // Update Interest Rates Dashboard
                updateInterestRatesDashboard(apiResponse.data.combined?.interestRates || [], symbol);
                
                // Update Support & Resistance with data
                updateSupportResistance(symbol, timeframe);
                
                // Update detailed analysis
                updateDetailedAnalysis(apiResponse.data, symbol, timeframe);
                
                console.log('Analysis update completed successfully');
        ...
        function loadChart() {
            ...
            setTimeout(() => {
                ...
                // Check if we can update analysis now or need to wait
                const now = Date.now();
                const timeSinceLastAnalysis = now - lastAnalysisUpdateTime;
                const MIN_ANALYSIS_INTERVAL = 30000; // 30 seconds minimum between analysis updates
                
                if (timeSinceLastAnalysis < MIN_ANALYSIS_INTERVAL) {
                    // Too soon to update analysis - schedule it for later
                    const delay = MIN_ANALYSIS_INTERVAL - timeSinceLastAnalysis;
                    console.log(`Analysis update scheduled in ${delay}ms (too soon)`);
                    
                    setTimeout(() => {
                        updateAnalysis(symbol, timeframeLabel);
                    }, delay);
                } else {
                    // Safe to update analysis now
                    updateAnalysis(symbol, timeframeLabel);
                }
        ...
        function exportData() {
            const data = {
                ...
                analysis: {
                    overallSignal: document.getElementById('overallSignal').textContent,
                    support: document.getElementById('supportLevel').textContent,
                    resistance: document.getElementById('resistanceLevel').textContent,
                    gaugeRating: document.getElementById('gaugeRating').textContent
                }
            };
            ...
            const exportFileDefaultName = `market-analysis-${data.symbol}-${new Date().toISOString().slice(0,10)}.json`;
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            style.textContent = `
                ...
                .loading-text, .loading-cell, .no-data {
                    text-align: center;
                    color: var(--text-secondary);
                    padding: 20px;
                    font-style: italic;
                ...
                .gauge-rating.strong-sell { color: #dc2626; }
                .gauge-rating.sell { color: #ef4444; }
                .gauge-rating.neutral { color: #f59e0b; }
                .gauge-rating.buy { color: #22c55e; }
                .gauge-rating.strong-buy { color: #10b981; }
                
                .rating-text.strong-sell { color: #dc2626; }
                .rating-text.sell { color: #ef4444; }
                .rating-text.neutral { color: #f59e0b; }
                .rating-text.buy { color: #22c55e; }
                .rating-text.strong-buy { color: #10b981; }
            `;
            document.head.appendChild(style);
            
            console.log('DOM Content Loaded - Initializing...');
            
            // Initialize gauge as neutral - FIXED: Now it will be neutral
