...
<body class="bg-dark text-light">
    <div class="container-fluid p-3 h-100">
        ...
        <div class="dashboard-layout row g-3 h-100">
            ...
            <div class="main-content-scrollable col-lg-8 col-md-12 h-100">
                <div class="main-content-wrapper h-100 overflow-auto pe-2">
                    <!-- Chart Section -->
                    <section class="chart-section card bg-dark border-secondary mb-3">
                    ...
                    <div class="lower-dashboard row g-3">
                        ...
                        <section class="widget card bg-dark border-secondary">
                            <div class="widget-header card-header border-secondary d-flex justify-content-between align-items-center">
                                <h2 class="h6 mb-0">📈 Market Analysis First Source</h2>
                                <div class="timeframe-display badge bg-primary" id="current-tf">4H</div>
                            </div>
                            <div class="widget-content card-body">
                                <div class="analysis-placeholder row g-3">
                                    <div class="analysis-item col-md-8">
                                    ...
                                    <div class="analysis-item col-md-4">
                                        <div class="p-3 bg-secondary rounded h-100">
                                            <h3 class="h6 mb-3">Support & Resistance</h3>
                                            <div class="indicator-row d-flex justify-content-between mb-2">
                                                <span>Support:</span>
                                                <span class="support fw-bold" id="supportLevel">158.50</span>
                                            </div>
                                            <div class="indicator-row d-flex justify-content-between mb-2">
                                                <span>Resistance:</span>
                                                <span class="resistance fw-bold" id="resistanceLevel">160.20</span>
                                            </div>
                                            <div class="indicator-row d-flex justify-content-between mb-2">
                                                <span>Pivot:</span>
                                                <span class="pivot fw-bold" id="pivotLevel">159.35</span>
                                            </div>
                                            <div class="indicator-row d-flex justify-content-between">
                                                <span>Range:</span>
                        ...
                        <section class="widget card bg-dark border-secondary">
                            <div class="widget-header card-header border-secondary d-flex justify-content-between align-items-center">
                                <h2 class="h6 mb-0">📈 Market Analysis Second Source</h2>
                                <div class="timeframe-display badge bg-primary" id="current-tf-second">4H</div>
                            </div>
                            <div class="widget-content card-body">
                                <div class="analysis-second-placeholder">
                                    <!-- Summary with Gauge -->
                                    <div class="analysis-container row g-3 mb-4">
                        ...
                        <section class="widget card bg-dark border-secondary" id="interestRatesWidget">
                            <div class="widget-header card-header border-secondary">
                            ...
                            <div class="widget-content card-body" id="interestRateContainer">
                                ...
                                <div class="stats-grid row g-3 mb-4" id="summaryStats">
