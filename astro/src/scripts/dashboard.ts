  ...
  document.getElementById("map-toggle")?.addEventListener("click", () => {
    ...
    if (toggleText) {
      toggleText.textContent =
        toggleText.textContent === "Maximize" ? "Minimize" : "Maximize";
    }
...
// Ensure initMap runs when the document is ready
