...
function updateMarketStatus(symbol) {
    ...
    if (statusElement) {
        statusElement.innerHTML = '<span class="live-dot me-2"></span> Live ' + symbol + ' Data';
    }
}
...
function updateFirstSourceAnalysis(data, symbol, timeframe) {
    ...
    summaryHeader.className = 'technical-summary-header p-3 bg-secondary rounded mb-3';
    summaryHeader.style.cssText = 'display: flex; justify-content: center; align-items: center; width: 100%; font-size: 14px;';
...
`;
    ...
    if (ta.patterns_sample && ta.patterns_sample.length > 0) {
        ta.patterns_sample.forEach(pattern => {
            ...
            if (pattern.buy) {
                ...
                buyDiv.className = 'bg-buy d-flex justify-content-center align-items-center text-uppercase fw-bold';
            ...
            if (pattern.sell) {
                ...
                sellDiv.className = 'bg-sell d-flex justify-content-center align-items-center text-uppercase fw-bold';
            ...
            if (pattern.signal && pattern.signal.toLowerCase() === 'both') {
                ...
                neutralDiv.className = 'bg-neutral d-flex justify-content-center align-items-center text-uppercase fw-bold mx-auto';
    ...
    legend.className = 'd-flex justify-content-between align-items-center mt-3 pt-3 border-top';
        ...
        analysisHTML += `
            <div class="analysis-card col-md-4">
                ...
                <div class="analysis-tags">
                    ...
                    ${buyCount > sellCount ? '<span class="badge bg-success ms-1">Bullish Bias</span>' : 
                      sellCount > buyCount ? '<span class="badge bg-danger ms-1">Bearish Bias</span>' : 
    ...
    if (investingData?.technical_indicators?.sample) {
        ...
        analysisHTML += `
            <div class="analysis-card col-md-4">
                ...
                <div class="analysis-tags">
                    ${buyCount > sellCount ? '<span class="badge bg-success">Bullish Bias</span>' : 
                      sellCount > buyCount ? '<span class="badge bg-danger">Bearish Bias</span>' : 
